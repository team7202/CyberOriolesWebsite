...
const Home: NextPage = (props) => {
  ...
  return (
    <div className='mt-[5vh]'>
      <h1 className='text-stone-200 hover:text-amber-500 hover:cursor-default text-2xl font-bold text-center select-none'>Welcome to the <span className='hover:text-amber-700'>Offical 7202 CyberOrioles</span> Website!</h1>
      ...
      <div className="translate-x-[30%] translate-y-[5%] w-[60vw] h-[50vh] rounded-lg bg-stone-800 duration-[2000ms] hover:bg-[#111111] hover:duration-[2000ms]">
        <div className='pl-[1vw] pr-[1vw] pt-[1vh] pb-[1vh]'>
          <div className="h-[48vh] ml-5 scrollbar-thin scrollbar-thumb-orange-400 hover:scrollbar-thumb-orange-500 active:scrollbar-thumb-orange-600 scrollbar-thumb-rounded-full scrollbar-track-black scrollbar-track-rounded-full cursor-default">
            <div className='pr-[0.5vw] text-[3vh]'>
