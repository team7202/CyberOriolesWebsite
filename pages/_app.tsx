...
function MyApp({ Component, pageProps }: { Component: NextComponentType<NextPageContext, any, any>, pageProps: Props }) {
  ...
  return (
      <div className='h-screen absolute cursor-default bg-stone-900 font-[poppins] scrollbar-thin scrollbar-thumb-orange-400 hover:scrollbar-thumb-orange-500 active:scrollbar-thumb-orange-600 scrollbar-thumb-rounded-full scrollbar-track-black scrollbar-track-rounded-full' id="news-root">
        <Head>
