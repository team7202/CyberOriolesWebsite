...
export default function App({ Component, pageProps }: AppProps) {
  ...
  return (
    <div className='w-screen h-screen bg-black text-orange-500 text-lg font-[Libre Franklin] overflow-y-auto overflow-x-hidden scrollbar-thin scrollbar-thumb-[rgba(1,1,1,0.8)] scrollbar-track-[rgba(1,1,1,0.8)]'>
      <div id='navbar' className='w-screen sm:h-[3.5vh] lg:h-[5vh] flex justify-center items-center gap-[3vw] bg-gradient-to-br from-orange-600 via-amber-300 to-orange-600 rounded-b-full absolute'>
        <Link href={"/"} className='absolute left-10 sm:text-[1.75vh] lg:text-[2.5vh] font-bold text-orange-600 hover:text-white duration-1000 bg-black sm:pl-[0.1vmin] sm:pt-[0.05vmin] sm:pr-[0.1vmin] sm:pb-[0.05vmin] md:pl-[calc(0.15vw+0.15vh)] md:pt-[calc(0.25vw+0.25vh)] md:pr-[calc(0.25vw+0.25vh)] md:pb-[calc(0.25vw+0.25vh)] rounded-full'>CyberOrioles</Link>
